...
| **F-04** | Aprobación del instructor como representante del cliente | Revisión y aceptación del producto terminado | Acordado el 14 sep 2026: aprueba al final, no cada documento por separado |
...
- **La validación** la hace el instructor como representante del cliente (F-04), al aprobar el producto terminado. Mientras tanto, los documentos se contrastan entre sí con los scripts de verificación.
...
- **Puede tener sesgo** por el vínculo familiar. Por eso cada hecho de F-05 queda registrado con su fecha y dónde se usa, para que el instructor lo revise al aprobar el producto (F-04).
