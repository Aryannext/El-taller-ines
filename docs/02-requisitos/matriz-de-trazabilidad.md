...
| RNF-06 | La integración con WhatsApp usa solo la API oficial | Compatibilidad | — | Revisión de código y prueba de integración con el número de prueba de Meta (ADR-003) |
